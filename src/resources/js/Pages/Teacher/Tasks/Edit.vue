  ...
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        ...
        <Link
          ...
          :href="route('courseTask.show', task.section_id)"
        >
    ...
    <div class="py-12">
      <div class="max-w-7xl  sm:px-6 lg:px-8">
       ...
       <template #description> Update  Name or Description.  </template>
          <template #form>
...
export default {
 ...
 setup(props) {
    const form = useForm({
      ...
      url_file:props.task.files,
    });
    const editTask = () => {
      form.post(route("updateTask",props.task));
    };
