  ...
  <app-layout>
    ...
    <div class="py-12">
      <div class="max-w-7xl  sm:px-6 lg:px-8">
        ...
        <template #title> Add Sections </template>

           <template #description> You Must Enter  Course Name,Section Number and  Teacher Name To Add New Section. </template>
          <template #form>
              <div class="col-span-6 sm:col-span-4">
              <jet-label for="course_id" class="required" value="Course" />
               <select v-model="form.course_id"  name="course_id" style="width: 500px;">
