  ...
  <app-layout>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <jet-form-section @submitted="UpdateStudent">
          <template #title> Update Student </template>

       <template #description> Update Full Name,Email,Phone or Student Level.  </template>
...
export default {
  ...
  setup(props) {
    const form = useForm({
      ...
      student_level: props.student.student_level,
